...
#
# `oysteR::expect_secure("pslr")` resolves the installed DESCRIPTION and audits
# pslr's declared dependencies against the Sonatype OSS Index. It is a network
