...
223 issues. Do not hand-edit: the next run overwrites this file
...
│   ├── PSLR-lararika [todo] [critical] R4: submit the approved rurl 3.0.0 release to CRAN
│   ├── PSLR-wzrevacl [todo] [critical] R5: verify rurl 3.0.0 is accepted and live on CRAN
...
223 stanzas, in sorted short-id order. Each is `fp context` output
